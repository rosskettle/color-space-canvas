var ColorSpaceCanvas=function(e,t){return this instanceof ColorSpaceCanvas?("undefined"==typeof e&&(e={}),console.log("aaa",e.axes),this._props={colorSpace:e.colorSpace||"hsv",colorValues:e.colorValues||[1,1,1],axes:e.axes||"sv"},"undefined"!=typeof t?(this.element=t,"width"in e||(this._props.width=t.width),"height"in e||(this._props.height=t.height)):this.element=this._createElement(),this._fragmentShaderSource=this._whichShader(this._props.colorSpace,this._props.axes),this._gl=this._getContext(),this._initGL(this._quadVertices(),this._fragmentShaderSource),this._setSize(),this._setAxes(),this._setColorValues(),this.draw(),void 0):new ColorSpaceCanvas(userProps,t)};ColorSpaceCanvas.prototype={setProps:function(e){console.log(e);for(var t in e)if(t in this._props)switch(this._props[t]=e[t],t){case"colorValues":this._setColorValues();case"constant1":this._setColorValues();case"axes":this._setAxes();case"width":case"height":this._setSize()}this.draw()},draw:function(){var e=this._gl;e.clearColor(1,1,1,1),e.clear(e.COLOR_BUFFER_BIT),e.drawArrays(e.TRIANGLE_STRIP,0,4)},_whichShader:function(e,t){var s=e.toUpperCase()+"Source";return 1===t.length?ColorSpaceCanvas.Shaders[s+"1D"]:2===t.length?ColorSpaceCanvas.Shaders[s+"2D"]:void 0},_shaderProgram:null,_uniforms:null,_attributes:null,_vertexBuffer:null,_setSize:function(){this.element.setAttribute("width",this._props.width),this.element.setAttribute("height",this._props.height),this._gl.viewport(0,0,this._props.width,this._props.height),this._gl.uniform2f(this._uniforms.uResolution,this._props.width,this._props.height),this._setResolution()},_setResolution:function(){this._gl.uniform2f(this._uniforms.uResolution,this._props.width,this._props.height)},_setAxes:function(){console.log("_setAxes",this._props.axes);var e;switch(this._props.axes){case"l":case"ab":case"ch":case"r":case"gb":case"h":case"sv":case"sl":e=0;break;case"a":case"lb":case"lh":case"g":case"rb":case"s":case"hv":case"hs":e=1;break;case"b":case"lb":case"lc":case"b":case"rg":case"v":case"hl":e=2}this._gl.uniform1i(this._uniforms.uChannel,e)},_setColorValues:function(){this._gl.uniform3fv(this._uniforms.uColorValues,new Float32Array(this._props.colorValues))},_createElement:function(){var e=document.createElement("canvas");return e},_getContext:function(){return this.element.getContext("webgl")},_quadVertices:function(){return new Float32Array([1,1,-1,1,1,-1,-1,-1])},_initGL:function(e,t){this._shaderProgram=this._loadShaders(t),this._uniforms=this._getUniforms(this._shaderProgram),this._attributes=this._getAttributes(this._shaderProgram),this._vertexBuffer=this._loadVertexBuffer(e),this._bind()},_loadShaders:function(e){var t=this._gl,s=["attribute vec2 aXY;","void main(void) {","   gl_Position = vec4(aXY, 0, 1.0);","}"].join("\n"),r=t.createShader(t.VERTEX_SHADER);if(t.shaderSource(r,s),t.compileShader(r),!t.getShaderParameter(r,t.COMPILE_STATUS))throw new Error("Vertex Shader compilation failed.");var i=t.createShader(t.FRAGMENT_SHADER);if(t.shaderSource(i,e),t.compileShader(i),!t.getShaderParameter(i,t.COMPILE_STATUS))throw new Error("Fragment Shader compilation failed.");var a=t.createProgram();if(t.attachShader(a,i),t.attachShader(a,r),t.linkProgram(a),!t.getProgramParameter(a,t.LINK_STATUS))throw new Error("Shaders failed to link");return t.useProgram(a),a},_getUniforms:function(e){return{uResolution:this._gl.getUniformLocation(e,"uResolution"),uChannel:this._gl.getUniformLocation(e,"uChannel"),uColorValues:this._gl.getUniformLocation(e,"uColorValues")}},_getAttributes:function(e){return{aXY:this._gl.getAttribLocation(e,"aXY")}},_loadVertexBuffer:function(e){var t=this._gl,s=t.createBuffer();return t.bindBuffer(t.ARRAY_BUFFER,s),t.bufferData(t.ARRAY_BUFFER,e,t.STATIC_DRAW),s},_bind:function(){var e=this._gl;e.enableVertexAttribArray(this._attributes.aXY),e.bindBuffer(e.ARRAY_BUFFER,this._vertexBuffer),e.vertexAttribPointer(this._attributes.aXY,2,e.FLOAT,!1,0,0)}},"undefined"!=typeof module&&(module.exports=ColorSpaceCanvas);
